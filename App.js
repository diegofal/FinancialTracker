...
const KpiCard = ({
  ...
  return (
    ...
    >
      ...
      {secondaryValue && (
        <Text style={styles.kpiSecondary}>{secondaryValue}</Text>
      )}
    </TouchableOpacity>
  );
};
...
export default function App() {
  ...
  const accountsData = [
    {
      name: "INDUSTRIAL DAX",
      balance: "$2,321,899.15",
      due: "$2,321,899.15",
      type: 0,
    },
    {
      name: "BRICOD CONTADO",
      balance: "$2,977,776.20",
      due: "$2,295,247.96",
      type: 0,
    },
    {
      name: "INDUSTRIAL CONVER",
      balance: "$45,618.91",
      due: "$45,618.91",
      type: 0,
    },
  ...
  const invoicesData = [
    {
      date: "12/05/2025",
      customer: "Cliente Ejemplo SA",
      invoice: "FC-A001-00012345",
      amount: "$121,000.00",
    },
    {
      date: "11/05/2025",
      customer: "Distribuidora Industrial",
      invoice: "FC-A001-00012346",
      amount: "$345,200.00",
    },
    {
      date: "10/05/2025",
      customer: "Bridas Argentinas",
      invoice: "FC-A001-00012347",
      amount: "$188,650.00",
    },
    {
      date: "09/05/2025",
      customer: "Metalúrgica del Sur",
      invoice: "FC-A001-00012348",
      amount: "$475,900.00",
    },
  ];
  ...
  const stockData = [
    {
      code: "TR12X6",
      description: "Tee de Reducción STD 1/2x3/4",
      stock: "0",
      sold: "5",
      cost: "$7,687.00",
      date: "30/08/2023",
      status: "Necesita Reposicion",
    },
    {
      code: "BSS15014",
      description: "Bridas S-150 SORF de 1/4",
      stock: "23",
      sold: "39",
      cost: "$6,707.04",
      date: "25/03/2025",
    ...
    {
      code: "BSS3006",
      description: "Bridas S-300 SORF de 6",
      stock: "9",
      sold: "42",
      cost: "$5,383.19",
      date: "13/12/2024",
    ...
    {
      code: "ES/BX3/4",
      description: "Espárragos R7 de 3/4 Cabeza Hexagonal",
      stock: "29",
      sold: "2004",
      cost: "$4,917.75",
      date: "10/02/2025",
  ...
  const discontinuedData = [
    {
      code: "BS15012",
      description: "Brida S-150 SORF 1/2",
      stock: "15",
      category: "Bridas",
      lastSale: "10/05/2020",
      value: "$25,000.00",
    ...
    {
      code: "EB7-5/8X4",
      description: "Espárrago B7 de 5/8 x 4",
      stock: "50",
      category: "Accesorios",
      lastSale: "22/11/2019",
      value: "$15,000.00",
    ...
    {
      code: "TR2X1",
      description: "Tee de Reducción STD 2x1",
      stock: "8",
      category: "Accesorio Forjado",
      lastSale: "15/02/2021",
      value: "$12,000.00",
    },
  ];
  ...
  const accountsColumns = [
    ...
    { title: "Balance", key: "balance", flex: 1 },
    {
      ...
      key: "due",
      flex: 1,
      textStyle: (item) => (item.type === 0 ? styles.redText : null),
    },
  ];
  ...
  const stockColumns = [
    ...
    { title: "Description", key: "description", flex: 2 },
    {
      ...
      key: "stock",
      flex: 0.7,
      textStyle: (item) => (item.stock === "0" ? styles.redText : null),
    },
        ...
        return (
          <View style={styles.tabContent}>
            ...
            <View style={styles.filterButtons}>
              <TouchableOpacity
                style={[styles.periodButton, styles.activePeriodButton]}
              >
            ...
            <CustomTable data={invoicesData} columns={invoicesColumns} />
          </View>
        );
          ...
          <View style={styles.tabContent}>
            <View style={styles.stockTabs}>
              <TouchableOpacity
                style={[
                  styles.stockTab,
                  activeStockTab === "current" ? styles.activeStockTab : null,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.stockTab,
                  activeStockTab === "discontinued"
                    ? styles.activeStockTab
                    : null,
                ]}
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.kpiContainer}>
          ...
          <KpiCard title="Total Deuda Vencida" primaryValue="$4,662,863.01" />
        ...
        <View style={styles.tabsContainer}>
          <View style={styles.tabs}>
            <TouchableOpacity
              style={[
                styles.tab,
                activeTab === "accounts" ? styles.activeTab : null,
              ]}
            ...
            >
              <Text
                style={[
                  styles.tabText,
                  activeTab === "accounts" ? styles.activeTabText : null,
                ]}
              >
                Cuentas Corriente
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.tab,
                activeTab === "invoices" ? styles.activeTab : null,
              ]}
              onPress={() => setActiveTab("invoices")}
            >
              <Text
                style={[
                  styles.tabText,
                  activeTab === "invoices" ? styles.activeTabText : null,
                ]}
              >
                Facturas
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.tab,
                activeTab === "stock" ? styles.activeTab : null,
              ]}
            ...
            >
              <Text
                style={[
                  styles.tabText,
                  activeTab === "stock" ? styles.activeTabText : null,
                ]}
              >
                Stock
              </Text>
